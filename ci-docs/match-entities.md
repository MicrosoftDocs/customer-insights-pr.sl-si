...
Ko določite vrstni red ujemanja, se definirani pari ujemanja prikažejo v **Podatki o ujemajočih se zapisih** razdelek o **Podatki** > **Združite** > **tekmo**. Ključne meritve so prazne, dokler se postopek ujemanja ne zaključi.
...
Obogatena entiteta vsebuje izvirna vir podatkov polja in obogatena polja. Če se torej odločite za delo z obogateno entiteto, to ne vpliva na obstoječo konfiguracijo. Vendar pa boste morda morali posodobiti pravila ujemanja, da boste namesto tega uporabljali obogatena polja.
