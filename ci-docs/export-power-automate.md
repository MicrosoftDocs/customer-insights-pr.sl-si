...
- Opravite lahko največ 100 klicev na 60 sekund. API končna točka lahko večkrat pokličete z uporabo parametra $skip. [Preberite več o parametru $skip](/connectors/customerinsights/#get-items-from-an-entity).
