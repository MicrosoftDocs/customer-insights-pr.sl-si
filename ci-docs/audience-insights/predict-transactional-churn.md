---
title: Predvidevanje izgube transakcij
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Navajanje izbirnega seznama referenčnih računov (samo poslovni računi)
